...
import com.example.farmasiku.activity.adapter.HistoryAdapter;
import com.example.farmasiku.activity.database.DatabaseHelper;
import com.example.farmasiku.activity.model.HistoryModel;
...
public class HistoryActivity extends AppCompatActivity {
    ...
    public void refreshList() {
        ...
        for (int i = 0; i < cursor.getCount(); i++) {
            ...
            riwayat = "Berhasil melakukan delivery obat untuk melakukan perjalanan dari " + asal + " menuju " + tujuan + " pada tanggal " + tanggal + ". " +
                    "Jumlah pembelian obat dewasa sejumlah " + dewasa + " dan obat anak-anak sejumlah " + anak + ".";
